...
QT_INIT_METAOBJECT const QMetaObject AQNewProjectDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_AQNewProjectDialog.data,
    qt_meta_data_AQNewProjectDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void path_edit_widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<path_edit_widget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject path_edit_widget::staticMetaObject = { {
    ...
    qt_meta_stringdata_path_edit_widget.data,
    qt_meta_data_path_edit_widget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject ANewProjectWizard::staticMetaObject = { {
    ...
    qt_meta_stringdata_ANewProjectWizard.data,
    qt_meta_data_ANewProjectWizard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
