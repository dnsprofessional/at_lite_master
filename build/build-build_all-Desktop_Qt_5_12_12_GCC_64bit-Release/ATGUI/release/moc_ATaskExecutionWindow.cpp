...
#include "../../../../src/ATGUI/ATaskExecutionWindow.h"
...
void ATaskExecutionWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ATaskExecutionWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ATaskExecutionWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ATaskExecutionWindow::discardTask)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ATaskExecutionWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ATaskExecutionWindow::commitTask)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ATaskExecutionWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_ATaskExecutionWindow.data,
    qt_meta_data_ATaskExecutionWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
