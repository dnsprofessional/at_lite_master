...
public:
    ...
    void setupUi(QDialog *ADatastreamDialog_dialogClass)
    {
        if (ADatastreamDialog_dialogClass->objectName().isEmpty())
            ADatastreamDialog_dialogClass->setObjectName(QString::fromUtf8("ADatastreamDialog_dialogClass"));
        ...
        inc_data_list->setObjectName(QString::fromUtf8("inc_data_list"));
        ...
        out_data_list->setObjectName(QString::fromUtf8("out_data_list"));
