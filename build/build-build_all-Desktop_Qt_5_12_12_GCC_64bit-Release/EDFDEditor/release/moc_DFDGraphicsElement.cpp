...
void DFDGraphicsElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DFDGraphicsElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DFDGraphicsElement::staticMetaObject = { {
    ...
    qt_meta_stringdata_DFDGraphicsElement.data,
    qt_meta_data_DFDGraphicsElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject DFDGraphicsAnchor::staticMetaObject = { {
    &DFDGraphicsElement::staticMetaObject,
    qt_meta_stringdata_DFDGraphicsAnchor.data,
    qt_meta_data_DFDGraphicsAnchor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
