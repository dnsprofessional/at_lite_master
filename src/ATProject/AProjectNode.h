...
class AT_PROJECT_API AProjectNode : public ANamedObject
{
...
Group is folder.
*/
class AT_PROJECT_API AGroupProjectNode : public AProjectNode
{
public:
...
Node for project.
*/
class AT_PROJECT_API ARootProjectNode : public AGroupProjectNode
{
public:
...
class AT_PROJECT_API ADocumentProjectNode : public AGroupProjectNode
{
public:	
