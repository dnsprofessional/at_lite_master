...
bool isType(SrcType* src){
    return dynamic_cast<DstType*>(src) != NULL;
}
...
public:
    ...
    // virtual string to_krl(const knowledge_field_t& kf) const = 0;
};
...
public:
    ...
    string to_krl(knowledge_field_t& kf) {
        return "OBJECTS";
    };
...
class temporal_condition_operation_condition: public condition_t {
private:
    condition_t * cond;
    temporal_entity_t * entity;

public:
    virtual ~temporal_condition_operation_condition(){}
    temporal_condition_operation_condition(condition_t * cond, temporal_entity_t * entity): cond(cond), entity(entity){}

    temporal_entity_t * get_entity () {
      return entity;
    }
    condition_t * get_condition_t () const {
          return cond;
    }
    ...
    virtual string to_interval_xml(const knowledge_field_t& kf) const override;
    virtual string to_rule_xml(const knowledge_field_t& kf) const override;
    virtual bool is_temporal() const {return true;}
};
...
public:
    ...
    condition_t* get_condition_t(int id) const{
        return data[id];
    }
...
public:
    ...
    const condition_t* get_duration_condition() const  {
        return duration_condition;
    }
     condition_t* get_begin_condition_t()   {
        return begin_condition;
    }
     condition_t* get_end_condition_t()   {
        return end_condition;
    }
     condition_t* get_duration_condition_t()   {
        return duration_condition;
    }
...
public:
    ...
    inline condition_t* get_condition_t()  {
        return condition;
    }
    inline  action_t* get_action_t()  {
        return action;
    }
...
public:
    ...
    int get_type_id_by_attr_name(string name) const {
        for (pair<string, int> it : type_ids) {
            if (it.first == name) {
                return it.second;
            }
        }
